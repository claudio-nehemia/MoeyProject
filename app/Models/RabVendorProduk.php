...
class RabVendorProduk extends Model
{
    use HasFactory;
    ...
    protected $casts = [
        ...
        'harga_total_aksesoris' => 'decimal:2',
        'harga_akhir' => 'decimal:2',
    ];

    public function rabVendor()
    {
        return $this->belongsTo(RabVendor::class);
    }
    ...
    public function rabVendorAksesoris()
    {
        return $this->hasMany(RabVendorAksesoris::class);
    }
}

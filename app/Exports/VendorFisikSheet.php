...
class VendorFisikSheet implements FromArray, WithTitle, WithStyles, ShouldAutoSize
{
    protected $order;
    protected $data;
    ...
    {
        $rows = [
            ['Rincian Pembayaran Vendor Fisik Utama - ' . $this->order->nama_project],
            [''],
        ...
        $rows[] = [''];
        $rows[] = ['Rincian Material Hutang Fisik (Dinamis)'];
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // Format currencies and group headers
        ...
        $sheet->getStyle('H4:H20')->getNumberFormat()->setFormatCode('#,##0');
    }
}

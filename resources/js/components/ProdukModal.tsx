...
export default function ProdukModal({
    ...
    return (
        ...
        >
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-rose-400 to-rose-600 px-6 py-4">
                ...
                <form onSubmit={onSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all"
                                placeholder="0"
                                disabled={processing}
                                step="0.01"
                            />
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="flex-1 px-4 py-2.5 bg-gradient-to-r from-rose-400 to-rose-600 text-white rounded-lg hover:from-rose-500 hover:to-rose-700 transition-all font-medium shadow-lg shadow-rose-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
                        >

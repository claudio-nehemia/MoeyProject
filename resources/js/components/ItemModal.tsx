...
export default function ItemModal({
    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/50 backdrop-blur-sm fadeIn">
            <div
                className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 fadeInUp"
                onClick={(e) => e.stopPropagation()}
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-orange-400 to-orange-600 rounded-t-2xl px-5 py-3 flex items-center justify-between">
                ...
                <form onSubmit={onSubmit} className="p-5 space-y-3.5">
                    ...
                    <div className="flex gap-2.5 pt-3">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 px-3 py-2 text-sm font-medium text-stone-700 bg-stone-100 hover:bg-stone-200 rounded-lg transition-colors"
                        >
                            Cancel
                        </button>
                        <button
                            type="submit"
                            disabled={processing}
                            className="flex-1 px-3 py-2 text-sm font-medium text-white bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >

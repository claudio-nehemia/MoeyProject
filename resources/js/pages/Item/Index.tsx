                ...
                <div className="mb-4 sm:mb-5">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-2">
                        <div className="flex items-center gap-2.5">
                            ...
                            <h1 className="text-2xl sm:text-3xl font-bold text-stone-900">Item Management</h1>
                        </div>
                        <button
                            onClick={openCreateModal}
                            className="w-full sm:w-auto px-3 sm:px-3.5 py-2 text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 rounded-lg shadow-md hover:shadow-lg transition-all flex items-center justify-center sm:justify-start gap-2"
                        >
                ...
                <div className="bg-white rounded-xl shadow-sm border border-stone-100 overflow-hidden overflow-x-auto">
                    {filteredItems.length === 0 ? (
                        <div className="p-6 sm:p-8 text-center">
                            ...
                            <p className="text-stone-600 text-xs sm:text-sm">{searchQuery || selectedJenisItem ? 'No results found' : 'No items found. Create your first item to get started.'}</p>
                        </div>
                    ) : (
                                        ...
                                        <tr key={item.id} className="border-b border-stone-100 hover:bg-stone-50/50 transition-colors">
                                            ...
                                            <td className="px-3 sm:px-4 py-2.5">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center shadow-sm flex-shrink-0">
                                                        <span className="text-xs font-bold text-white">
                                                            {item.nama_item.charAt(0).toUpperCase()}
                                                        </span>
                                                    </div>
                                                    <span className="font-medium text-stone-900 truncate">{item.nama_item}</span>
                                                </div>
                                            </td>

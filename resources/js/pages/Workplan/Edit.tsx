                ...
                <div className="mb-6">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2 rounded-lg bg-white border border-stone-200 px-4 py-2 shadow-sm">
                                <div className="h-2 w-24 rounded-full bg-stone-200 overflow-hidden">
                                    <div 
                                        className="h-full bg-gradient-to-r from-emerald-500 to-green-500 transition-all duration-500"
                                        style={{ width: `${workplanProgress}%` }}
                                    />
                                </div>
                                <span className="text-sm font-semibold text-stone-700">{workplanProgress}%</span>
                            </div>
                        </div>
                    </div>
                </div>

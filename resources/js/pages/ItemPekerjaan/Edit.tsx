...
export default function Edit({ itemPekerjaan, produks, jenisItems, items }: Props) {
                                        ...
                                        <div key={produk.temp_id} className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                                            ...
                                            <div className="mb-4 flex items-start justify-between">
                                                <h4 className="font-semibold text-purple-900">
                                                    Produk #{pIndex + 1} 
                                                    {produk.id && <span className="ml-2 text-xs text-purple-600">(ID: {produk.id})</span>}
                                                </h4>
                                                <button
                                                    type="button"
                                                            ...
                                                            <div key={jenisItem.temp_id} className="rounded-lg border border-blue-200 bg-blue-50 p-3">
                                                                <div className="mb-3 flex items-start justify-between">
                                                                    <span className="text-sm font-medium text-blue-900">
                                                                        Jenis Item #{jIndex + 1}
                                                                        {jenisItem.id && <span className="ml-2 text-xs text-blue-600">(ID: {jenisItem.id})</span>}
                                                                    </span>
                                                                    <button
                                                                        type="button"

                                                                ...
                                                                {item.kontrak && item.kontrak.durasi_kontrak && (
                                                                    <div className="space-y-2">
                                                                        ...
                                                                        <div className="flex flex-wrap items-center gap-2">
                                                                            ...
                                                                            {/* Download Draft Word */}
                                                                            <a
                                                                                href={`/kontrak/${item.kontrak!.id}/export-word`}
                                                                                target="_blank"
                                                                                className="inline-flex items-center gap-1 rounded-lg bg-sky-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition-all duration-200 hover:bg-sky-700 hover:shadow-md"
                                                                                title="Download Draft Kontrak Word"
                                                                            >
                                                                                <svg
                                                                                    className="h-4 w-4"
                                                                                    fill="none"
